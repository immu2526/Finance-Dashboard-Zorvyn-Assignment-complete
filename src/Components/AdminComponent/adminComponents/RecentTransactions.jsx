    ...
    <div className="bg-white rounded-xl border border-gray-100 p-4 mt-2">
      ...
      <div class="max-w-sm w-fullspace-y-3 flex items-center gap-2 mb-3">
        ...
        <button
          ...
          type="button"
          class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium text-white rounded-lg bg-black border border-secondary-line hover:bg-secondary-hover focus:outline-hidden focus:bg-secondary-hover disabled:opacity-50 disabled:pointer-events-none"
        >
          add
        </button>
      </div>
